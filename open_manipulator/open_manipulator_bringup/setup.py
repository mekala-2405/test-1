...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'test_individual_joint_control = open_manipulator_bringup.test_individual_joint_control:main',
            'manual_joint_control = open_manipulator_bringup.manual_joint_control:main',
            'simple_joint_example = open_manipulator_bringup.simple_joint_example:main',
        ],
    },
)
