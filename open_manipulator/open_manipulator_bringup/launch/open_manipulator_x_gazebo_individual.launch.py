...
#
# Modified for individual joint control
...
def generate_launch_description():
    ...
    xacro_file = os.path.join(
        ...
        'urdf',
        'open_manipulator_x',
        'open_manipulator_x_individual.urdf.xacro',
    )
    ...
    # Controller spawner nodes for individual joint control
    ...
    # Optional: Uncomment to launch RViz
