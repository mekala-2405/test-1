...
//
// Author: Ryan Shim, Sungho Woo, Wonho Yun, Woojin Wie, Heewon Lee
...
#include <QMessageBox>
#include <iostream>
#include "../include/omx_f_gui/main_window.hpp"
...
: QMainWindow(parent), qnode(argc, argv)
{
  ...
  QStringList headers;
  headers << "Joint 1" << "Joint 2" << "Joint 3" << "Joint 4" << "Joint 5" << "Gripper" << "Status";
